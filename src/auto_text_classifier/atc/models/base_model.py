...
class BaseModel():
    def __init__(self, config):
        ...
        self.data_num_workers = self.config.get("data_num_workers",2) # dataloader的并行数
    ...
    def train(self, train_path, dev_path, test_path):
        ...
        :param train_path: train data
        :type train_path: csv/object
        :param dev_path: dev data
        :type dev_path: csv/object
        :param test_path: test data
        :type test_path: csv/object
        """        
